...
trait FoldableSyntax {
  implicit def foldableOps[F[_], A](fa: F[A])(implicit F: TC[F, Foldable]): FoldableSyntax.Ops[F, A] =
    new FoldableSyntax.Ops(fa)(F.instance)

  implicit def foldableOpsU[F[_], FA](fa: FA)(implicit F: TCU[Foldable, FA]): FoldableSyntax.Ops[F.T, F.A] =
